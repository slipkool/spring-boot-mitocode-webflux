package com.personal.webflux.app.config;
...
import com.personal.webflux.app.handler.ClienteHandler;
import com.personal.webflux.app.handler.FacturaHandler;
import com.personal.webflux.app.handler.PlatoHandler;
...
public class RouterConfig {
    ...
    @Bean
    public RouterFunction<ServerResponse> rutasCliente(ClienteHandler handler) {
    ...
    @Bean
    public RouterFunction<ServerResponse> rutasFactura(FacturaHandler handler) {
